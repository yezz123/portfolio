...
featured: false
excerpt: 'Generate a FullStack playground using FastAPI, GraphQL and Ariadne'
image: '/images/blog/11/01.jpg'
---
...
- Open the GraphQL PlayGround by visiting [http://localhost:8000](http://localhost:8000). Paste the hello query below and hit the “Play” button:
...
To be honest, this got quite long. If you are patient enough to read this full and find it interesting then please share it, and [Follow me on x](https://x.com/THyasser1) for the next articles.
