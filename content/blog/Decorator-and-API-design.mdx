...
featured: true
excerpt: "A decorator is a design pattern in Python that allows a user to add new functionality to an existing object without modifying its structure."
image: "/images/blog/14/01.png"
---
